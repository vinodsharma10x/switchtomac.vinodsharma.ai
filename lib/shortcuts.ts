...
export const TASKS: Task[] = [
  ...
  { c: "shots", t: "Take a screenshot of part of the screen", win: "Win + Shift + S", m: ["⌘", "⇧", "4"], how: "Press it, drag the crosshair over the area, and release — it saves to your Desktop. Add Control (⌃⌘⇧4) to copy it to the clipboard instead.", kw: "snip region capture screenshot" },
  { c: "shots", t: "Record your screen", win: "Win + G (Game Bar)", m: ["⌘", "⇧", "5"], how: "This opens a small toolbar. Choose Record Entire Screen or Record Selected Portion, then click Record. Stop from the icon in the menu bar.", kw: "screen recording video capture" },
